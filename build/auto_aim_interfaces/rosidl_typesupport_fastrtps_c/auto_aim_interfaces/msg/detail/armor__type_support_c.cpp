...
#include "geometry_msgs/msg/detail/point__functions.h"  // img_features
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: img_features
  {
    ...
    size_t size = ros_message->img_features.size;
    auto array_ptr = ros_message->img_features.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: img_features
  {
    ...
    if (ros_message->img_features.data) {
      geometry_msgs__msg__Point__Sequence__fini(&ros_message->img_features);
    }
    if (!geometry_msgs__msg__Point__Sequence__init(&ros_message->img_features, size)) {
      fprintf(stderr, "failed to create array for field 'img_features'");
      return false;
    }
    auto array_ptr = ros_message->img_features.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  size_t current_alignment)
{
  ...
  // field.name img_features
  {
    size_t array_size = ros_message->img_features.size;
    auto array_ptr = ros_message->img_features.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
