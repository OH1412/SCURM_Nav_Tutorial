  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: offset_yaw
  {
    cdr << ros_message->offset_yaw;
  }

  // Field name: offset_pitch
  {
    cdr << ros_message->offset_pitch;
  }

  // Field name: fire_permit
  {
    cdr << ros_message->fire_permit;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name offset_yaw
  {
    size_t item_size = sizeof(ros_message->offset_yaw);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name offset_pitch
  {
    size_t item_size = sizeof(ros_message->offset_pitch);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name fire_permit
  {
    size_t item_size = sizeof(ros_message->fire_permit);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
