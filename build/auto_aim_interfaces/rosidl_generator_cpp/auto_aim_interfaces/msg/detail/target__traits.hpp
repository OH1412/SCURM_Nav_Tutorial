  ...
  std::ostream & out)
{
  ...
  {
    out << "offset_yaw: ";
    rosidl_generator_traits::value_to_yaml(msg.offset_yaw, out);
    out << ", ";
  }
  ...
  {
    out << "offset_pitch: ";
    rosidl_generator_traits::value_to_yaml(msg.offset_pitch, out);
    out << ", ";
  }
  ...
  {
    out << "fire_permit: ";
    rosidl_generator_traits::value_to_yaml(msg.fire_permit, out);
  }
  out << "}";
