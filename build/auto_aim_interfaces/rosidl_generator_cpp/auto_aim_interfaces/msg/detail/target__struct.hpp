...
struct Target_
{
  ...
  using _dz_type =
    double;
  _dz_type dz;
  using _offset_yaw_type =
    float;
  _offset_yaw_type offset_yaw;
  using _offset_pitch_type =
    float;
  _offset_pitch_type offset_pitch;
  using _fire_permit_type =
    uint8_t;
  _fire_permit_type fire_permit;
  ...
  Type & set__offset_yaw(
    const float & _arg)
  {
    this->offset_yaw = _arg;
    return *this;
  }
  Type & set__offset_pitch(
    const float & _arg)
  {
    this->offset_pitch = _arg;
    return *this;
  }
  Type & set__fire_permit(
    const uint8_t & _arg)
  {
    this->fire_permit = _arg;
    return *this;
  }
  ...
  bool operator==(const Target_ & other) const
  {
    ...
    if (this->offset_yaw != other.offset_yaw) {
      return false;
    }
    if (this->offset_pitch != other.offset_pitch) {
      return false;
    }
    if (this->fire_permit != other.fire_permit) {
      return false;
    }
    return true;
  }
