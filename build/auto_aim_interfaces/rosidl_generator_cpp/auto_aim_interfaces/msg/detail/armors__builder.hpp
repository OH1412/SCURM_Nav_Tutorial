...
class Init_Armors_fulldetect
{
public:
  explicit Init_Armors_fulldetect(::auto_aim_interfaces::msg::Armors & msg)
  : msg_(msg)
  {}
  ::auto_aim_interfaces::msg::Armors fulldetect(::auto_aim_interfaces::msg::Armors::_fulldetect_type arg)
  {
    msg_.fulldetect = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_Armors_fulldetect armors(::auto_aim_interfaces::msg::Armors::_armors_type arg)
  {
    msg_.armors = std::move(arg);
    return Init_Armors_fulldetect(msg_);
  }
