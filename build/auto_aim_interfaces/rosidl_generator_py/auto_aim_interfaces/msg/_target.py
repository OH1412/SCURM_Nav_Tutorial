...
class Target(metaclass=Metaclass_Target):
    ...
    def __init__(self, **kwargs):
        ...
        self.offset_yaw = kwargs.get('offset_yaw', float())
        self.offset_pitch = kwargs.get('offset_pitch', float())
        self.fire_permit = kwargs.get('fire_permit', int())
    ...
    def __eq__(self, other):
        ...
        if self.dz != other.dz:
            return False
        if self.offset_yaw != other.offset_yaw:
            return False
        if self.offset_pitch != other.offset_pitch:
            return False
        if self.fire_permit != other.fire_permit:
            return False
        return True
    ...
    @builtins.property
    def offset_yaw(self):
        """Message field 'offset_yaw'."""
        return self._offset_yaw

    @offset_yaw.setter
    def offset_yaw(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'offset_yaw' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'offset_yaw' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._offset_yaw = value

    @builtins.property
    def offset_pitch(self):
        """Message field 'offset_pitch'."""
        return self._offset_pitch

    @offset_pitch.setter
    def offset_pitch(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'offset_pitch' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'offset_pitch' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._offset_pitch = value

    @builtins.property
    def fire_permit(self):
        """Message field 'fire_permit'."""
        return self._fire_permit

    @fire_permit.setter
    def fire_permit(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'fire_permit' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'fire_permit' field must be an unsigned integer in [0, 255]"
        self._fire_permit = value
