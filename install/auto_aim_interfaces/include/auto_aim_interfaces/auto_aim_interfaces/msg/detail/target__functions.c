...
auto_aim_interfaces__msg__Target__are_equal(const auto_aim_interfaces__msg__Target * lhs, const auto_aim_interfaces__msg__Target * rhs)
{
  ...
  // offset_yaw
  if (lhs->offset_yaw != rhs->offset_yaw) {
    return false;
  }
  // offset_pitch
  if (lhs->offset_pitch != rhs->offset_pitch) {
    return false;
  }
  // fire_permit
  if (lhs->fire_permit != rhs->fire_permit) {
    return false;
  }
  return true;
}
  ...
  auto_aim_interfaces__msg__Target * output)
{
  ...
  output->dz = input->dz;
  // offset_yaw
  output->offset_yaw = input->offset_yaw;
  // offset_pitch
  output->offset_pitch = input->offset_pitch;
  // fire_permit
  output->fire_permit = input->fire_permit;
  return true;
}
