...
static rosidl_typesupport_introspection_c__MessageMember auto_aim_interfaces__msg__Armors__rosidl_typesupport_introspection_c__Armors_message_member_array[3] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(auto_aim_interfaces__msg__Armors, fulldetect),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
