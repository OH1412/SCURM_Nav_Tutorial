...
class Init_Armor_img_features
{
public:
  explicit Init_Armor_img_features(::auto_aim_interfaces::msg::Armor & msg)
  : msg_(msg)
  {}
  ::auto_aim_interfaces::msg::Armor img_features(::auto_aim_interfaces::msg::Armor::_img_features_type arg)
  {
    msg_.img_features = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_Armor_img_features pose(::auto_aim_interfaces::msg::Armor::_pose_type arg)
  {
    msg_.pose = std::move(arg);
    return Init_Armor_img_features(msg_);
  }
...
public:
  ...
  {}
  Init_Armor_number header(::auto_aim_interfaces::msg::Armor::_header_type arg)
  {
...
{
  return auto_aim_interfaces::msg::builder::Init_Armor_header();
}
