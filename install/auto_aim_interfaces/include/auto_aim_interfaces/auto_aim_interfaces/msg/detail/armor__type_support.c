...
size_t auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__size_function__Armor__img_features(
...
const void * auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__get_const_function__Armor__img_features(
...
void * auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__get_function__Armor__img_features(
...
void auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__fetch_function__Armor__img_features(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const geometry_msgs__msg__Point * item =
    ((const geometry_msgs__msg__Point *)
    auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__get_const_function__Armor__img_features(untyped_member, index));
  geometry_msgs__msg__Point * value =
    (geometry_msgs__msg__Point *)(untyped_value);
  *value = *item;
}

void auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__assign_function__Armor__img_features(
  void * untyped_member, size_t index, const void * untyped_value)
{
  geometry_msgs__msg__Point * item =
    ((geometry_msgs__msg__Point *)
    auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__get_function__Armor__img_features(untyped_member, index));
  const geometry_msgs__msg__Point * value =
    (const geometry_msgs__msg__Point *)(untyped_value);
  *item = *value;
}

bool auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__resize_function__Armor__img_features(
...
static rosidl_typesupport_introspection_c__MessageMember auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__Armor_message_member_array[6] = {
  {
    ...
    offsetof(auto_aim_interfaces__msg__Armor, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(auto_aim_interfaces__msg__Armor, img_features),  // bytes offset in struct
    NULL,  // default value
    auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__size_function__Armor__img_features,  // size() function pointer
    auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__get_const_function__Armor__img_features,  // get_const(index) function pointer
    auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__get_function__Armor__img_features,  // get(index) function pointer
    auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__fetch_function__Armor__img_features,  // fetch(index, &value) function pointer
    auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__assign_function__Armor__img_features,  // assign(index, value) function pointer
    auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__resize_function__Armor__img_features  // resize(index) function pointer
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, auto_aim_interfaces, msg, Armor)() {
  auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__Armor_message_member_array[0].members_ =
