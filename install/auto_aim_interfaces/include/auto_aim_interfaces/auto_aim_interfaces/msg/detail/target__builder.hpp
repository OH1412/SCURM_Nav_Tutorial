...
class Init_Target_fire_permit
{
public:
  explicit Init_Target_fire_permit(::auto_aim_interfaces::msg::Target & msg)
  : msg_(msg)
  {}
  ::auto_aim_interfaces::msg::Target fire_permit(::auto_aim_interfaces::msg::Target::_fire_permit_type arg)
  {
    msg_.fire_permit = std::move(arg);
...
class Init_Target_offset_pitch
{
public:
  explicit Init_Target_offset_pitch(::auto_aim_interfaces::msg::Target & msg)
  : msg_(msg)
  {}
  Init_Target_fire_permit offset_pitch(::auto_aim_interfaces::msg::Target::_offset_pitch_type arg)
  {
    msg_.offset_pitch = std::move(arg);
    return Init_Target_fire_permit(msg_);
  }
...
class Init_Target_offset_yaw
{
public:
  explicit Init_Target_offset_yaw(::auto_aim_interfaces::msg::Target & msg)
  : msg_(msg)
  {}
  Init_Target_offset_pitch offset_yaw(::auto_aim_interfaces::msg::Target::_offset_yaw_type arg)
  {
    msg_.offset_yaw = std::move(arg);
    return Init_Target_offset_pitch(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_Target_offset_yaw dz(::auto_aim_interfaces::msg::Target::_dz_type arg)
  {
    msg_.dz = std::move(arg);
    return Init_Target_offset_yaw(msg_);
  }
...
class Init_Target_control
{
public:
  explicit Init_Target_control(::auto_aim_interfaces::msg::Target & msg)
  : msg_(msg)
  {}
  Init_Target_id control(::auto_aim_interfaces::msg::Target::_control_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_Target_control tracking(::auto_aim_interfaces::msg::Target::_tracking_type arg)
  {
    msg_.tracking = std::move(arg);
    return Init_Target_control(msg_);
  }
