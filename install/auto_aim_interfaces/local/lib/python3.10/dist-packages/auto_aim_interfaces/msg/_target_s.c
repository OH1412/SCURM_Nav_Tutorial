...
bool auto_aim_interfaces__msg__target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // offset_yaw
    PyObject * field = PyObject_GetAttrString(_pymsg, "offset_yaw");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->offset_yaw = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // offset_pitch
    PyObject * field = PyObject_GetAttrString(_pymsg, "offset_pitch");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->offset_pitch = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // fire_permit
    PyObject * field = PyObject_GetAttrString(_pymsg, "fire_permit");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->fire_permit = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * auto_aim_interfaces__msg__target__convert_to_py(void * raw_ros_message)
{
  ...
  {  // offset_yaw
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->offset_yaw);
    {
      int rc = PyObject_SetAttrString(_pymessage, "offset_yaw", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // offset_pitch
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->offset_pitch);
    {
      int rc = PyObject_SetAttrString(_pymessage, "offset_pitch", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // fire_permit
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->fire_permit);
    {
      int rc = PyObject_SetAttrString(_pymessage, "fire_permit", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
