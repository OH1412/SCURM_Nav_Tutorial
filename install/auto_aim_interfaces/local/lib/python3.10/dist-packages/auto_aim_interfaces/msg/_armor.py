...
class Armor(metaclass=Metaclass_Armor):
    ...
    _fields_and_field_types = {
        ...
        'img_features': 'sequence<geometry_msgs/Point>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.img_features = kwargs.get('img_features', [])
    ...
    def __eq__(self, other):
        ...
        if self.pose != other.pose:
            return False
        if self.img_features != other.img_features:
            return False
        return True
    ...
    def img_features(self):
        """Message field 'img_features'."""
        return self._img_features

    @img_features.setter
    def img_features(self, value):
        if __debug__:
            from geometry_msgs.msg import Point
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'img_features' field must be a set or sequence and each value of type 'Point'"
        self._img_features = value
